...
- **Source**: https://github.com/fabric-testbed/loomai-dev/tree/main/hub
...
The Hub is designed to run as part of the LoomAI Helm chart on Kubernetes. See the [Kubernetes deployment docs](https://github.com/fabric-testbed/loomai-dev/blob/main/docs/KUBERNETES.md) for full instructions.
