...
| Version | Description |
|---------|-------------|
| 0.6.0   | Persistent tunnel manager, HTTP/HTTPS protocol support, AI tool enhancements, version alignment with LoomAI v0.6.0 |
...
```bash
docker pull fabrictestbed/loomai-hub:0.6.0
docker run -d \
  -p 8081:8081 \
  -v hub_data:/app/data \
  ...
  fabrictestbed/loomai-hub:0.6.0
```
